              ...
              <div className="image-wrapper">
                <Lazyload throttle={50} height={1100}>
                  <ReactCSSTransitionGroup key="1"
                    ...
                    transitionLeave={false}>
                      <img className="img-bordered" src="B_img1.jpg" alt="" />
                ...
                <Lazyload throttle={50} height={1100}>
                  <ReactCSSTransitionGroup key="1"
                    ...
                    transitionEnter={false}
                    transitionLeave={false}>
                      <img className="img-bordered" src="B_img2.jpg" alt="" />
                  </ReactCSSTransitionGroup>
                </Lazyload>
                <Lazyload throttle={50} height={1100}>
                  <ReactCSSTransitionGroup key="1"
                    ...
                    transitionEnter={false}
                    transitionLeave={false}>
                      <img className="img-bordered" src="B_img3.jpg" alt="" />
                  </ReactCSSTransitionGroup>
                </Lazyload>
                <p>
                  <a target="_blank" href="http://www.energytomorrow.org">Live site</a>
                </p>
              </div>
            </div>
          </div>
